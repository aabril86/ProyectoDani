...
@Database(entities = {Juego.class}, version = 16, exportSchema = false)
...
public abstract class AppBaseDeDatos extends RoomDatabase {
    ...
    static void insertarJuegosIniciales(AppDao appDao){
        executor.execute(() -> {
            appDao.insertarJuego(new Juego("Rocket", "2019", "Psyonix","Rocket League is a high-powered hybrid of arcade-style soccer and vehicular mayhem with easy-to-understand controls and fluid, physics-driven competition." ,"PC","file:///android_asset/rocket_league_portada.png","file:///android_asset/rocket_banner.png", "https://www.epicgames.com/store/es-ES/product/rocket-league/home"));
            appDao.insertarJuego(new Juego("Genshin", "2019", "miHoYo","Genshin Impact is an open world action role-playing game that allows the player to control one of four interchangeable characters in a party. Switching between characters can be done quickly and during combat to the player to use several different combinations of skills and attacks.","PC","file:///android_asset/genshin_impact_portada.png", "file:///android_asset/genshin_banner.png", "https://genshin.mihoyo.com/en"));
            appDao.insertarJuego(new Juego("Valorant", "2019", "Riot","Valorant is a team-based tactical shooter and first-person shooter set in the near-future. Players play as one of a set of agents, characters designed based on several countries and cultures around the world","PC","file:///android_asset/valorant_portada.png", "file:///android_asset/valorant_banner.png", "https://playvalorant.com/es-es/"));
            appDao.insertarJuego(new Juego("Warzone", "2019", "Infinity Award","Warzone features two primary game modes: Battle Royale and Plunder.[5] It is the second main battle royale installment in the Call of Duty franchise, following the \"Blackout\" mode of Call of Duty: Black Ops 4 (2018)","PC","file:///android_asset/cod_portada.png", "file:///android_asset/cod_banner.png", "https://www.callofduty.com/es/warzone"));
            appDao.insertarJuego(new Juego("Runeterra", "2019", "Riot","Legends of Runeterra is played 1v1. Each player begins the match with a hand of four playing cards randomly selected from their card deck, a 20-health-point nexus, and zero mana.","PC", "file:///android_asset/runeterra_portada.png", "file:///android_asset/runaterra_banner.png", "https://playruneterra.com/es-es/"));
            appDao.insertarJuego(new Juego("CSGO", "2016", "Valve","Two opposing teams, known as the Terrorists and the Counter-Terrorists, compete in game modes to complete objectives, such as securing a location to plant or defuse a bomb and rescuing or guarding hostages.","Steam", "file:///android_asset/icon_csgo.png", "file:///android_asset/csgo_banner.png", "https://store.steampowered.com/app/730/CounterStrike_Global_Offensive/"));
            appDao.insertarJuego(new Juego("Fortnite", "2017", "Epic","Players can use their pickaxe to knock down existing structures on the map to collect basic resources that are wood, brick, and metal. Subsequently, in all modes, the player can use these materials to build fortifications, such as walls, floors, and stairs.","Epic", "file:///android_asset/icon_fortnite.png", "file:///android_asset/fortnite_banner.png", "https://www.epicgames.com/fortnite/es-ES/home"));
            appDao.insertarJuego(new Juego("DOTA", "2016", "Valve","Dota 2 is a multiplayer online battle arena (MOBA) video game in which two teams of five players compete to collectively destroy a large structure defended by the opposing team known as the \"Ancient\", whilst defending their own.","Steam", "file:///android_asset/icon_dota.png", "file:///android_asset/dota_banner.png", "https://www.dota2.com/play/"));
            appDao.insertarJuego(new Juego("Path of Exile", "2015","Valve","Dota 2 is a multiplayer online battle arena (MOBA) video game in which two teams of five players compete to collectively destroy a large structure defended by the opposing team known as the \"Ancient\", whilst defending their own.", "Steam", "file:///android_asset/icon_poe.png", "file:///android_asset/poe_banner.png", "https://www.pathofexile.com/game"));
            appDao.insertarJuego(new Juego("League of Legends", "2015", "Riot","As in other multiplayer online battle arena (MOBA) games, each player in League of Legends controls a character (\"champion\") with a set of unique abilities.[2] Most games involve two teams of five players, with each player using a different champion.","/", "file:///android_asset/icon_lol.png", "file:///android_asset/lol_banner.png", "https://play.euw.leagueoflegends.com/es_ES"));
        });
    }
}
