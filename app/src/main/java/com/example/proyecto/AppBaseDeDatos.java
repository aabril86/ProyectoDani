...
@Database(entities = {Juego.class}, version = 14, exportSchema = false)
...
public abstract class AppBaseDeDatos extends RoomDatabase {
    ...
    static void insertarJuegosIniciales(AppDao appDao){
        executor.execute(() -> {
            ...
            appDao.insertarJuego(new Juego("Path of Exile", "2015","Valve","Dota 2 is a multiplayer online battle arena (MOBA) video game in which two teams of five players compete to collectively destroy a large structure defended by the opposing team known as the \"Ancient\", whilst defending their own.", "Steam", "file:///android_asset/icon_poe.png", "file:///android_asset/poe_banner.png"));
